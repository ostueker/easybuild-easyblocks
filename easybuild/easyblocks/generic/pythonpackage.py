...
def det_installed_python_packages(log, names_only=True, python_cmd=None, path=None):
...
class PythonPackage(ExtensionEasyBlock):
    ...
    def get_installed_python_packages(self, names_only=True, python_cmd=None, path=None):
        ...
        return det_installed_python_packages(self.log, names_only, python_cmd, path)
